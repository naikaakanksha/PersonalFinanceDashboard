...
app.config['MAIL_PASSWORD'] = 'your_email_password'   # Use App Password
mail = Mail(app)
...
class Transaction(db.Model):
    ...
    details = db.Column(db.JSON, nullable=False)      # {"Food": 500, "Rent": 2000}
    ...
    if request.method == "POST":
        ...
        try:
            msg = Message(
                ...
                recipients=[email],
                body=f"Hi {fullname},\n\nWelcome to Finance App! Your registration was successful."
            )
            mail.send(msg)
